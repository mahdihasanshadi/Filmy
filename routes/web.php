...
// send a mail via Notifcation route
Route::get('/send-mail', function () {
    Notification::route('mail', 'mahdi.hasan.shadi@g.bracu.ac.bd')->notify(new ResetPasswordMail());
});

Route::get('login', [FilmyAuthController::class, 'login']);
Route::post('login/post', [FilmyAuthController::class, 'loginPost']);

Route::get('register', [FilmyAuthController::class, 'register']);
Route::post('register', [FilmyAuthController::class, 'shadiPost'])->name('register');
